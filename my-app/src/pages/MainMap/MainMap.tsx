...
import { useNavigate, useLocation } from 'react-router-dom'; // useNavigate 훅 사용
...
const MainMap: React.FC = () => {
  ...
  const allowedPaths = [
    '/mainmap',
    '/MainMap/BeginnerStudymap',
    '/mainmap/intermediateStudymap',
    '/mainmap/advancedStudymap'
];
