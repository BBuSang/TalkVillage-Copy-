...
//		System.out.println("닉네임 : "+nickname+" 생일 : " + birthday+" 스킨 번호 : " + basicSkin);
		...
		inventory.setUser(sessionuser);
		inventory.setState(true);
		inventory.setStore(skin);
	...
	public String ChangePW(@RequestParam String pw, @RequestParam String email) {
		User user = userRep.findByEmail(email);
